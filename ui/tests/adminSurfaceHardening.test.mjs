...
const adminPageSource = read('ui/src/pages/AdminPage.jsx');
...
const usersSectionSource = read('ui/src/pages/admin/components/AdminUsersSection.jsx');
...
const createUserModalSource = read('ui/src/pages/admin/components/CreateUserModal.jsx');
...
const roleCopySource = read('ui/src/pages/admin/adminRoleCopy.js');
