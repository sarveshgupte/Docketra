  ...
  return (
    <div className={`w-full relative ${className}`}>
      ...
      <textarea
        ...
        aria-controls={showSuggestions && suggestions.length > 0 ? `${textareaId}-mentions` : undefined}
        aria-autocomplete={enableMentions ? "list" : undefined}
        aria-activedescendant={showSuggestions && suggestions.length > 0 ? `${textareaId}-mention-${selectedIndex}` : undefined}
        value={value}
