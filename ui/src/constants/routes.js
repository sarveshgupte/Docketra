export const ROUTES = {
  ...
  PCS_COMMAND_CENTER: (firmSlug) => `/app/firm/${firmSlug}/pcs-command-center`,
  COMPLIANCE: (firmSlug) => `/app/firm/${firmSlug}/compliance`,
  COMPLIANCE_CONTROL: (firmSlug) => `/app/firm/${firmSlug}/compliance-calendar`,
