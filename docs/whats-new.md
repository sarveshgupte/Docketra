...
- Fixed client-management denial messaging and stale admin-only denial copy so allowed Manager/Admin/Primary Admin paths use: **"Client management requires Admin access"**.
