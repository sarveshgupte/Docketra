...
- **Category Management** lives under Task Manager and represents category + subcategory + workbasket linkage configuration, including optional subcategory checklist templates used to seed new docket checklist snapshots. It also supports optional subcategory SOP/work instructions that are snapshotted into each docket at creation time.
