...
const { requirePrimaryAdmin, requireRole } = require('../middleware/rbac.middleware');
...
router.put('/configuration', userWriteLimiter, requirePrimaryAdmin, updateAiConfiguration);
router.post('/test-configuration', userWriteLimiter, requirePrimaryAdmin, testAiConfiguration);
