...
const SECURITY_AUDIT_ACTIONS = Object.freeze({
  ...
  UPLOAD_TURNSTILE_MISSING: 'UPLOAD_TURNSTILE_MISSING',
  UPLOAD_TURNSTILE_FAILED: 'UPLOAD_TURNSTILE_FAILED',
  UPLOAD_TURNSTILE_PASSED: 'UPLOAD_TURNSTILE_PASSED',
  LOGIN_VERIFY_TURNSTILE_MISSING: 'LOGIN_VERIFY_TURNSTILE_MISSING',
  LOGIN_VERIFY_TURNSTILE_FAILED: 'LOGIN_VERIFY_TURNSTILE_FAILED',
  LOGIN_VERIFY_TURNSTILE_PASSED: 'LOGIN_VERIFY_TURNSTILE_PASSED',
});
