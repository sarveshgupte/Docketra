...
const ROLE_PERMISSIONS = {
  PRIMARY_ADMIN: [
    'CASE_VIEW','CASE_CREATE','CASE_UPDATE','CASE_ACTION','CASE_ASSIGN','CASE_ADMIN_VIEW','USER_VIEW','USER_MANAGE','CLIENT_VIEW','CLIENT_MANAGE','CLIENT_APPROVE','CATEGORY_VIEW','CATEGORY_MANAGE','WORKTYPE_VIEW','WORKTYPE_MANAGE','REPORT_VIEW','TASK_VIEW','TASK_MANAGE','ADMIN_STATS','STORAGE_MANAGE','TEAM_MANAGE','FIRM_SETTINGS','WORK_SETTINGS','WORKBASKET_MANAGE','FIRM_SETTINGS_MANAGE','SLA_RULES_MANAGE'
  ],
  ADMIN: [
    'CASE_VIEW','CASE_CREATE','CASE_UPDATE','CASE_ACTION','CASE_ASSIGN','CASE_ADMIN_VIEW','USER_VIEW','USER_MANAGE','CLIENT_VIEW','CLIENT_MANAGE','CLIENT_APPROVE','CATEGORY_VIEW','CATEGORY_MANAGE','WORKTYPE_VIEW','WORKTYPE_MANAGE','REPORT_VIEW','TASK_VIEW','TASK_MANAGE','ADMIN_STATS','TEAM_MANAGE','FIRM_SETTINGS','WORK_SETTINGS','FIRM_SETTINGS_MANAGE','SLA_RULES_MANAGE'
  ],
  MANAGER: [
