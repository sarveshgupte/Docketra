...
const mapClientResponse = (client) => {
  ...
  return {
    ...
    businessContactNumber: sanitizeProtectedValue(client.primaryContactNumber),
    ...
    contactPersonPhone: client.contactPersonPhoneNumber ?? null,
    contactPersonEmailAddress: client.contactPersonEmailAddress ?? null,
    contactPersonEmail: client.contactPersonEmailAddress ?? null,
    PAN: client.PAN ?? null,
    TAN: client.TAN ?? null,
    GST: client.GST ?? null,
    CIN: client.CIN ?? null,
