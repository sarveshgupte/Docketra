...
const createDocumentItem = async (req, res) => {
  try {
    ...
    log.error('DOCUMENT_CREATE_ERROR', { message: error.message, stack: error.stack });
...
const addDocumentVersion = async (req, res) => {
  try {
    ...
    log.error('DOCUMENT_VERSION_ERROR', { message: error.message, stack: error.stack });
...
const getDocumentItems = async (req, res) => {
  try {
    ...
    log.error('DOCUMENT_FETCH_ALL_ERROR', { message: error.message, stack: error.stack });
...
const getDocumentItemById = async (req, res) => {
  try {
    ...
    log.error('DOCUMENT_FETCH_ERROR', { message: error.message, stack: error.stack });
...
const updateDocumentStatus = async (req, res) => {
  try {
    ...
    log.error('DOCUMENT_STATUS_ERROR', { message: error.message, stack: error.stack });
...
const selectCurrentVersion = async (req, res) => {
  try {
    ...
    log.error('DOCUMENT_VERSION_SELECT_ERROR', { message: error.message, stack: error.stack });
