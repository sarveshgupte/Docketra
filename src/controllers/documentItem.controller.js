...
const createDocumentItem = async (req, res) => {
  try {
    ...
    log.error('CREATE_DOCUMENT_ITEM_FAILED', { message: error.message, stack: error.stack });
...
const addDocumentVersion = async (req, res) => {
  try {
    ...
    log.error('UPLOAD_DOCUMENT_VERSION_FAILED', { message: error.message, stack: error.stack });
...
const getDocumentItems = async (req, res) => {
  try {
    ...
    log.error('FETCH_DOCUMENT_ITEMS_FAILED', { message: error.message, stack: error.stack });
...
const getDocumentItemById = async (req, res) => {
  try {
    ...
    log.error('FETCH_DOCUMENT_ITEM_FAILED', { message: error.message, stack: error.stack });
...
const updateDocumentStatus = async (req, res) => {
  try {
    ...
    log.error('UPDATE_DOCUMENT_STATUS_FAILED', { message: error.message, stack: error.stack });
...
const selectCurrentVersion = async (req, res) => {
  try {
    ...
    log.error('SELECT_CURRENT_VERSION_FAILED', { message: error.message, stack: error.stack });
