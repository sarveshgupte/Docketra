...
const createUser = async (req, res) => {
  ...
  try {
    ...
    const user = new User({
      ...
      createdBy: req.user?._id || null, // Sentinel: derived from authenticated user instead of payload
    });
...
const updateUser = async (req, res) => {
  try {
    ...
    user.updatedBy = req.user?._id || null; // Sentinel: derived from authenticated user instead of payload
