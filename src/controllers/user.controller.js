...
const createUser = async (req, res) => {
  ...
  try {
    ...
    const user = new User({
      ...
      createdBy: req.user?._id || null, // Derived securely from authenticated user context
    });
...
const updateUser = async (req, res) => {
  try {
    ...
    user.updatedBy = req.user?._id || null; // Derived securely from authenticated user context
