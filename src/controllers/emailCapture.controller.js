...
const createEmailCapture = async (req, res) => {
  try {
    ...
    log.error('Failed to capture email content', { error, userXID: req.user?.xID });
...
const getEmailCaptures = async (req, res) => {
  try {
    ...
    log.error('Failed to fetch email captures', { error, userXID: req.user?.xID });
...
const getEmailCaptureById = async (req, res) => {
  try {
    ...
    log.error('Failed to fetch email capture', { error, userXID: req.user?.xID });
...
const updateEmailCapture = async (req, res) => {
  try {
    ...
    log.error('Failed to update email capture', { error, userXID: req.user?.xID });
...
const linkToDocket = async (req, res) => {
  try {
    ...
    log.error('Failed to link email capture to docket', { error, userXID: req.user?.xID });
...
const createDocketFromEmail = async (req, res) => {
  try {
    ...
    log.error('Failed to spawn docket from email capture', { error, userXID: req.user?.xID });
