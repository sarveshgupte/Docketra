...
const resendSetup = async (req, res) => {
  ...
  // 💡 What: Replaced countDocuments() with find().limit(3).
  // 🎯 Why: countDocuments forces a full index scan. When checking if a threshold is met (e.g. >= 3), find().limit(3) is O(1) and stops after finding 3 items.
  // 📊 Impact: O(1) early return performance instead of O(N).
