...
const config = {
  ...
  security: {
    rateLimit: {
      ...
      loginPerMinute: Number(process.env.SECURITY_RATE_LIMIT_LOGIN_PER_MINUTE || 10),
      forgotPasswordPerMinute: Number(process.env.SECURITY_RATE_LIMIT_FORGOT_PASSWORD_PER_MINUTE || 5),
      publicPerMinute: Number(process.env.SECURITY_RATE_LIMIT_PUBLIC_PER_MINUTE || 60),
