...
## 2026-08-16 - Revert $facet for simple counts
...
**Action:** Replaced memory-intensive $facet aggregation with concurrent Case.countDocuments() queries via Promise.all().
