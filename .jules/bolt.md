...
## 2026-07-03 - Run independent count queries concurrently
**Learning:** Found sequential execution of count queries in src/services/dashboard.service.js.
**Action:** Moved the stalePending count query into an existing Promise.all block to run it concurrently with other queries.
