...
## 2024-09-11 - Avoid Duplicated Attributes
**Learning:** Duplicated HTML/ARIA attributes in React components cause invalid HTML and break screen reader functionality.
**Action:** Ensure elements have single, unique IDs and ARIA attributes.
