...
assert.ok(permissionMiddleware.includes("normalizedRequiredPermissions.includes('CLIENT_MANAGE')"), 'permission middleware must special-case CLIENT_MANAGE denial copy');
