...
export default function CompanySecretariesSolutionPage() {
  return (
        ...
        <div className="mx-auto max-w-5xl rounded-3xl border border-slate-800 bg-slate-950 p-6 sm:p-10 shadow-2xl">
          <div className="text-center max-w-2xl mx-auto mb-8">
            ...
            <p className="mt-2 text-xs sm:text-sm text-slate-400">
              Live telemetry: how Docketra organizes client entity memory, MCA statutory clocks, and board governance.
            </p>
          </div>
